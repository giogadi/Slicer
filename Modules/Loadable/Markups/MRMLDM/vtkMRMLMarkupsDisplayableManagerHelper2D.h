...
==============================================================================*/
/// .NAME vtkMRMLMarkupsDisplayableManagerHelper2D - utility class to manage widgets
/// .SECTION Description
...
#ifndef VTKMRMLMARKUPSDISPLAYABLEMANAGERHELPER2D_H_
#define VTKMRMLMARKUPSDISPLAYABLEMANAGERHELPER2D_H_
...
class VTK_SLICER_MARKUPS_MODULE_MRMLDISPLAYABLEMANAGER_EXPORT vtkMRMLMarkupsDisplayableManagerHelper2D :
    public vtkObject
{
public:

  static vtkMRMLMarkupsDisplayableManagerHelper2D *New();
  vtkTypeRevisionMacro(vtkMRMLMarkupsDisplayableManagerHelper2D, vtkObject);
...
protected:
  ...
  vtkMRMLMarkupsDisplayableManagerHelper2D();
  virtual ~vtkMRMLMarkupsDisplayableManagerHelper2D();
...
private:
  ...
  vtkMRMLMarkupsDisplayableManagerHelper2D(const vtkMRMLMarkupsDisplayableManagerHelper2D&); /// Not implemented
  void operator=(const vtkMRMLMarkupsDisplayableManagerHelper2D&); /// Not Implemented
...
#endif /* VTKMRMLMARKUPSDISPLAYABLEMANAGERHELPER2D_H_ */
